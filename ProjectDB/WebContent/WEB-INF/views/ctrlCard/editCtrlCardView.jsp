...
<title>Редактирование КК</title>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-3.3.1.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/forEditCtrlCardView.js"></script>
<style>
	body{
...
<body>
	...
	<header>
		<h1 style="display:inline;">Редактирование карты контроля</h1>
	</header>
	<div id="tableDiv">
	<form method="POST" action="${pageContext.request.contextPath}/editCtrlCard">
		<table id="firstHead">
			<tr>
				<td></td>
				<td style ="width: 250px">
					<input style ="width: 230px" type="text" name="docName" value="${applicationScope.techCtrl.linkedObjs[0].docName}"/>
				</td>
		...
		<table id="secondHead">
			...
			<tr>
				...
				<td rowspan="0"></td>
				<td rowspan="0" width="180px">
				<input style ="width: 160px" type="text" name="docSign" value="${applicationScope.techCtrl.linkedObjs[0].docSign}"/>
				</td>
			</tr>
			<tr>
				<td>Проверил</td>
		...
		<table id="thirdHead">
			...
			<tr>
				...
				<input style ="width: 30px;" type="text" name="docLetter" value="${applicationScope.techCtrl.linkedObjs[0].docLetter}"/>
				</td>
				...
				<td>
					<table id="secondInHelp">
						...
						<tr style ="height: 40px;">
							...
							<td></td>
							<td>
								<input style ="width: 150px;" type="text" name="instructSign" value="${applicationScope.techCtrl.intsructSign}"/>
							</td>
						</tr>
					</table>
				</td>
		...
		<table id="bodyHead">
			...
			<c:set var="i" value="0"/>
			<c:forEach items="${applicationScope.techCtrl.paramControls}" var="paramCtrl">
