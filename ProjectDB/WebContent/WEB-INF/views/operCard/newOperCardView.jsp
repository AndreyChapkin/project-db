...
<title>Новая операционная карта</title>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-3.3.1.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/forNewOperCardView.js"></script>
<style>
	body{
...
<body>
	...
	<c:choose>
		<c:when test="${parentId == 0 or parentId == null}">
			<header>
				<h1 style="display:inline;">Создание новой операционной карты</h1>
			</header>
			<div id="tableDiv">
			<form method="POST" action="${pageContext.request.contextPath}/newOperCard">
				<table id="firstHead">
					<tr>
						<td></td>
						...
						<td>
							<table id="firstInHelp">
								...
								<tr>
									...
									<td>
										<input style ="width: 70px;" type="text" name="hardness" 
											   value="${applicationScope.techOper.assocObj.typicBlank.material.hardness}"/>
									</td>
									<td>
						...
						<td>
							<table id="secondInHelp">
								...
								<tr style ="height: 40px;">
									...
									<td>
										<input style ="width: 220px;" type="text" name="programSign"/>
									</td>
									<td>
									...
									<td>
										<input style ="width: 240px;" type="text" name="lcl"/>
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td>
							<table class="firstBody">
								<tr>
									<td style ="width: 40px">О 01</td>
									<td style="text-align:left; padding-left:4px;">
										<input style ="width: 20px" type="text" name="tranNumber" value="1" readonly/>. 
										<input style ="width: 880px" type="text" name="tranDescrip" value="Описание перехода"/>
									</td>
									<td style ="width: 60px">
										<input style ="width: 50px" type="text" name="tranMainTime"/>
									</td>
									<td style ="width: 60px">
										<input style ="width: 50px" type="text" name="tranAssistTime"/>
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td>
							<table class="secondBody">
								<tr>
									<td style ="width: 40px">Т 02</td>
									<td style="text-align:left; padding-left:4px;">
										<input style ="width: 1040px" type="text" name="toolsPile"/>
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td>
							<table class="thirdBody">
								<tr>
									<td style ="width: 40px">Р 03</td>
									<td></td>
									<td style ="width: 80px">
										<input style ="width: 70px" type="text" name="adjustPosNumber"/>
									</td>
									<td style ="width: 120px">
										<input style ="width:110px" type="text" name="treatWidth"/>
									</td>
									<td style ="width: 80px">
										<input style ="width: 70px" type="text" name="strokeLength"/>
									</td>
									<td style ="width: 50px">
										<input style ="width: 40px" type="text" name="cutDepth"/>
									</td>
									<td style ="width: 50px">
										<input style ="width: 40px" type="text" name="strokeCount"/>
									</td>
									<td style ="width: 80px">
										<input style ="width: 70px" type="text" name="supValue"/>
									</td>
									<td style ="width: 60px">
										<input style ="width: 50px" type="text" name="rotSpeed"/>
									</td>
									<td style ="width: 60px">
										<input style ="width: 50px" type="text" name="cutSpeed"/>
									</td>
								</tr>
							</table>
						</td>
				...
				<input type="button" id="newTransit" value="+переход"/>&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" id="newTools" value="+оснастка и режимы резания"/>
			</form>
			</div>
		</c:when>	
		<c:otherwise>
			<header>
				<h1 style="display:inline;">Создание новой версии операционной карты</h1>
			</header>
			<div id="tableDiv">
			<form method="POST" action="${pageContext.request.contextPath}/newOperCard">
				<table id="firstHead">
					<tr>
						<td></td>
						<td style ="width: 250px">
							<input style ="width: 230px" type="text" name="docName" value="${applicationScope.parentTechOper.linkedObjs[0].docName}"/>
						</td>
						<td style ="width: 20px"></td>
						<td style ="width: 20px"></td>
					</tr>
				...
				<table id="secondHead">
					...
					<tr>
						...
						<td rowspan="0"></td>
						<td rowspan="0" width="180px">
							${applicationScope.parentTechOper.assocObj.assocObj.prodSign}
						</td>
						<td rowspan="0"></td>
						<td rowspan="0" width="180px">
						<input style ="width: 160px" type="text" name="docSign" value="${applicationScope.parentTechOper.linkedObjs[0].docSign}"/>
						</td>
					</tr>
					<tr>
						<td>Проверил</td>
				...
				<table id="thirdHead">
					...
					<tr>
						...
						<td></td>
						<td rowspan="0">
						${applicationScope.parentTechOper.assocObj.assocObj.prodName}
						</td>
						<td rowspan="0" style ="width: 40px">
						<input style ="width: 30px;" type="text" name="docLetter" value="${applicationScope.parentTechOper.linkedObjs[0].docLetter}"/>
						</td>
						<td rowspan="0" style ="width: 40px"></td>
						<td rowspan="0" style ="width: 40px"></td>
					</tr>
					...
					<tr>
						<td>
							<table id="firstInHelp">
								...
								<tr>
									<td>
										${applicationScope.parentTechOper.typicOperation.operName}
									</td>
									<td>
										${applicationScope.parentTechOper.assocObj.typicBlank.material.matName}
										${applicationScope.parentTechOper.assocObj.typicBlank.material.matSort}
										${applicationScope.parentTechOper.assocObj.typicBlank.material.matStandart}
									</td>
									<td>
										<input style ="width: 70px;" type="text" name="hardness" 
											   value="${applicationScope.parentTechOper.assocObj.typicBlank.material.hardness}"/>
									</td>
									<td>
										${applicationScope.parentTechOper.assocObj.assocObj.measureUnit.measUnitName}
									</td>
									<td>
										${applicationScope.parentTechOper.assocObj.assocObj.prodWeight}
									</td>
									<td>
										${applicationScope.parentTechOper.assocObj.typicBlank.profile} x ${applicationScope.parentTechOper.assocObj.blankSize}
									</td>
									<td>
										${applicationScope.parentTechOper.assocObj.blankWeight}
									</td>
									<td>
										${applicationScope.parentTechOper.nspd}
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td>
							<table id="secondInHelp">
								...
								<tr style ="height: 40px;">
									<td>
										${applicationScope.parentTechOper.equipment.eqCode}, 
										${applicationScope.parentTechOper.equipment.eqName}
									</td>
									<td>
										<input style ="width: 220px;" type="text" name="programSign" value="${applicationScope.parentTechOper.programSign}"/>
									</td>
									<td>
										<input style ="width: 50px;" type="text" name="mainTime" value="${applicationScope.parentTechOper.mainTime}"/>
									</td>
									<td>
										<input style ="width: 50px;" type="text" name="assistTime" value="${applicationScope.parentTechOper.assistTime}"/>
									</td>
									<td>
										${applicationScope.parentTechOper.prepareTime}
									</td>
									<td>
										${applicationScope.parentTechOper.unitTime}
									</td>
									<td>
										<input style ="width: 240px;" type="text" name="lcl" value="${applicationScope.parentTechOper.lcl}"/>
									</td>
								</tr>
							</table>
						</td>
				...
				<table id="bodyHead">
					...
					<c:set var="i" value="0"/>
					<c:forEach items="${parentTechOper.techTransits}" var="techTran">
							...
							<table class="firstBody">
								<tr>
									...
									<td style="text-align:left; padding-left:4px;">
										...
										<input style ="width: 850px" type="text" name="tranDescrip" value="${techTran.tranDescrip}"/>
									</td>
									<td style ="width: 60px">
